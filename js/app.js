...
let menu = document.querySelector('.header__fit');
let bor = document.querySelector('.header__bor');
bor.addEventListener('click', function(){
   menu.classList.toggle('_open');
})

$(document).ready(function(){
   $(".example__product").slice(0, 6).show();
   $("#loadMore").on("click", function(e){
     e.preventDefault();
     $(".example__product:hidden").slice(0, 3).slideDown();
     if($(".example__product:hidden").length == 0) {
